/**
 * Simple & Lightweight Backend Password Decryption
 * Zero-dependency XOR Cipher with Hex decoding.
 */
const CRYPTO_SECRET_KEY = process.env.CRYPTO_SECRET_KEY || "SaiBabaStore@SecretKey2026";
